...
class TeamMemberVdc extends BaseModel
{
    protected $field = ['name', 'level', 'belong', 'become_price', 'discount', 'vdc_type', 'vdc_one', 'vdc_two', 'icon', 'status', 'handing_scale', 'become_condition', 'recommend_level', 'recommend_number', 'train_level', 'train_number', 'sales_team_level', 'sales_price', 'vdc_genre', 'growth_value', 'need_team_condition', 'close_first_divide', 'close_upgrade', 'sales_price', 'share_growth_scale', 'background', 'poster', 'demotion_sales_price', 'demotion_type','grateful_vdc_one','grateful_vdc_two','recommend_member_number','floors_withdraw_amount','withdraw_condition_amount','withdraw_amount','village_performance'];
